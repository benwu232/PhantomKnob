                ...
                VStack(spacing: 8) {
                    ZStack {
                        OverlayView(
                            ...
                            isDeadzone: viewModel.isDeadzone && viewModel.hoveredKnob == .doubleKnob,
                            isTooClose: viewModel.isTooClose && viewModel.hoveredKnob == .doubleKnob,
                ...
                VStack(spacing: 8) {
                    ZStack {
                        OverlayView(
                            ...
                            isDeadzone: viewModel.isDeadzone && viewModel.hoveredKnob == .cvkKnob,
                            isTooClose: viewModel.isTooClose && viewModel.hoveredKnob == .cvkKnob,
